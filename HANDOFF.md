...
>
> **★ 반영/확정 이력**: FR1(이전) + **FR2/FR3/FR4(2026-07-10 이 세션)**.
...
>
> **다음(재개 시)**: (1) **FR5/FR6 갱신**(FR3 엔진 출력이 FR5 코칭/FR6 리포트로 흐르는 배선 반영), (2) spec-001 "AI FR=FR2~6" 줄 확인, (3) **예측 서사 잔여 정합**(아직 예측=NN/ODE로 서술된 현행 문서: spec-002 QA1, spec-011, spec-021, spec-022, spec-023, arch/architecture-overview, adr-016, arch/zone2-physiology-and-estimation, report-002/003/004/007 — 대부분 FR5/6 재정립과 함께 손봐야 함), (4) FR3/FR6용 신규 spec(분석 엔진 상세 명세), (5) spec-004 §3 디커플링 δ=5% 마법상수 → 개인 k·σ로 재서술(정합 시). **문답식 유지, 서두르지 말 것.** 앱 구현 미변경.
>
> --- (이하 이전 기록) ---

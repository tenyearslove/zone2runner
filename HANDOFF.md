...
>
> **다음(재개 시) — FR 표 자체는 1차 완료, 이제 하위 문서 정합**: (1) **예측 서사 잔여 정합**(아직 예측=NN/ODE로 서술된 현행 문서: spec-002 QA1, spec-011, spec-021, spec-022, spec-023 FR6의 "예측 개인화 τ/드리프트 요약"→경계 Bayesian 요약, arch/architecture-overview, adr-016, arch/zone2-physiology-and-estimation, report-002/003/004/007), (2) FR3/FR6용 신규 spec(분석 엔진 상세 명세), (3) spec-004 §3 디커플링 δ=5% 마법상수 → 개인 k·σ로 재서술, (4) spec-002 QA 매핑을 재정립 FR과 재정합. **문답식 유지, 서두르지 말 것.** 앱 구현 미변경.
>
> --- (이하 이전 기록) ---

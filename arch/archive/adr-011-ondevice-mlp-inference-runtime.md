...
- **날짜**: 2026-07-03
- **상태**: Obsolete (2026-07-08 정리) — 앱 내 NN이 전부 제거되어(판정 MLP=adr-013, 역치 NN=adr-016, 심박예측 NN=adr-020) 이 런타임의 적용 대상 소멸. "TFLite 없이 순수 Kotlin 순전파" 결정 자체는 당시 유효했던 역사 기록. 원 상태: Accepted
- **결정자**: 성시원

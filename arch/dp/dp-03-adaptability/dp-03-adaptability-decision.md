...
> **"개인차가 ±10~15bpm에 이르는 Zone 2 경계를 — 참값 없이, 드물고 주관적인 사용자 라벨만으로, 폰 혼자 — 몇 세션 안에 그 사람에게 수렴시키고 이후 안정되게 유지하는 적응 구조를 무엇으로 할 것인가."**
...
### 6-4. 보완 계획
- **수렴 지표**: 시뮬 층위 실측은 완료했다 — 기준 사례 수렴 오차 12.9→1.73bpm, 참임계 5종×시드 3종 스윕 전부 1~2세션 안착, 오답 라벨 10% 주입에도 최종 0.09bpm(report-015 QA2). 잔여 = 실주행 데이터로 같은 지표 재측정(spec-012).

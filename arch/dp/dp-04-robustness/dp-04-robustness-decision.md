...
### 6-4. 보완 계획
- **일관성 지표**: 시뮬 층위 실측은 완료했다 — 이상치 기각율 100%(오탐 0/500), 번복 억제율 67~75%(시드 5종, 진짜 이동 1틱 — report-015 QA4). 진동 노이즈 크기(정현 2bpm+백색 σ1.5bpm)는 설계 선택(종류 C)이며 실주행 분포로 갱신한다. 잔여 = 실주행 데이터 재측정.

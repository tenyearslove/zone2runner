...
class Zone2PriorTest {
    ...
    @Test fun talkTest_threeLevelScale_directionAndConfidence() {
        // spec-016 AC-2: 강도 오름차순(편함→보통→벅참) z 단조 감소(방향) + BORDERLINE 최고 확신(최소 σ).
        ...
        // 방향: 편함은 상한을 올리고(임계 위), 벅참은 내린다(임계 아래).
        ...
        // 확신(σ): BORDERLINE(6) < COMFORTABLE/HARD(14), 단측 대칭.

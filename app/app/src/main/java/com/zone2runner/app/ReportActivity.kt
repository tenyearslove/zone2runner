...
class ReportActivity : AppCompatActivity() {
    ...
    private fun buildReport(r: RunReport): ScrollView {
        ...
        col.addView(TextView(this).apply {
            val src = if (r.sourceMode == "live") "실센서(GPS+심박센서)" else "시뮬레이션"
    ...
    private companion object {
        ...
        val METRIC_INFO = linkedMapOf(
            ...
            "개인 Zone 2 상단 학습" to "말하기 테스트 응답을 반영해 Zone 2 상한이 어떻게 달라졌는지 보여줘요. 세션이 쌓이면 프로필로 계산한 초기값에서 개인 응답을 반영한 경계로 조정됩니다.",

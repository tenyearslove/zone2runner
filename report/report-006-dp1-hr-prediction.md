...
**장점(QA 별점)**: 기능적응성 ★★★★ (공식 제약 없이 개인 비선형까지 배울 잠재 상한), 수행효율성 ★★★★ (소형 순전파는 온디바이스 가능)
...
|---|---|---|
| 구조 | §3 다이어그램 | §4 다이어그램 |
| 장점 | 설명용이성 ★★★★★<br/>강건성 ★★★★★ | 기능적응성 ★★★★<br/>수행효율성 ★★★★ |
...
1. **모집단 평균은 우리 병목이 아니다**: FitRec으로 학습한 백본이 주는 것은 "평균 Endomondo 사용자"의 심박 함수다. 우리 문제의 병목은 개인차(P2)라 그 위에 온라인 개인화 층이 어차피 필요한데, 생리 공식 뼈대 + 온라인 파라미터 추정만으로 이미 목표를 달성했다(폐루프 60초 RMSE 약 2.4bpm). 백본 교체로 얻는 것은 개인화 수렴 전 첫 몇 분뿐이고, 그 콜드스타트는 모집단 prior(문헌값 τ 등)가 이미 감당한다.
